            ...
            <ul class="navbar-nav  align-items-center">
                ...
                <li class="nav-item dropdown px-2">
                    <div class="flex items-center justify-center space-x-1">
                        <a class="px-2.5 py-2 bg-blue-700 text-white uppercase font-bold rounded-lg leading-none shadow-lg " href="#">B</a>
                        <a class="px-2.5 py-2 bg-red-700 text-white uppercase font-bold rounded-lg leading-none shadow-lg " href="#">R</a>
                    </div>
                </li>
            </ul>
        </div>
