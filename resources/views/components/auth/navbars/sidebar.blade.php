        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item {{ request()->is('expenses') ? ' active ' : '' }} ">
                <a href="{{ route('expenses.index') }}"
                    class="nav-link text-white {{ request()->is('expenses') ? ' active ' : '' }}"
                ...
                <div class="collapse {{ $activePage == 'allThemePages' ? ' show ' : '' }}  " id="themePages">
                    ...
                    <ul class="nav">
                        <li class="nav-item">
                            ...
                            <div class="collapse {{ $activePage == 'dashboard' ? ' show ' : '' }}  "
                                ...
                                <ul class="nav ">
                                    <li class="nav-item {{ $activeItem == 'user-profile' ? ' active ' : '' }}">
                                        <a class="nav-link text-white {{ $activeItem == 'user-profile' ? ' active ' : '' }}  "
                                            ...
                                            <span class="sidenav-normal  ms-2  ps-1"> User Profile <b
                                                    class="caret"></b></span>
                                        </a>
                                    </li>
                                    @can('manage-users', App\Models\User::class)
                                        <li class="nav-item {{ $activeItem == 'user-management' ? ' active ' : '' }}">
                                            <a class="nav-link text-white {{ $activeItem == 'user-management' ? ' active ' : '' }}  "
                                                ...
                                                <span class="sidenav-normal  ms-2  ps-1"> User Management <b
                                                        class="caret"></b></span>
                                            </a>
                                        </li>
                                        <li class="nav-item {{ $activeItem == 'role-management' ? ' active ' : '' }}">
                                            <a class="nav-link text-white {{ $activeItem == 'role-management' ? ' active ' : '' }}  "
                                                ...
                                                <span class="sidenav-normal  ms-2  ps-1"> Role Management <b
                                                        class="caret"></b></span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('manage-items', App\Models\User::class)
                                        ...
                                        <li class="nav-item {{ $activeItem == 'tag-management' ? ' active ' : '' }}">
                                            <a class="nav-link text-white {{ $activeItem == 'tag-management' ? ' active ' : '' }}  "
                                                ...
                                                <span class="sidenav-normal  ms-2  ps-1"> Tag Management <b
                                                        class="caret"></b></span>
                                            </a>
                                        </li>
                                    @endcan
                                    @can('manage-items', App\Models\User::class)
                                        <li class="nav-item {{ $activeItem == 'item-management' ? ' active ' : '' }}">
                                            <a class="nav-link text-white {{ $activeItem == 'item-management' ? ' active ' : '' }}  "
                                                ...
                                                <span class="sidenav-normal  ms-2  ps-1"> Item Management <b
                                                        class="caret"></b></span>
                                            </a>
                                        </li>
                                    @else
                                        <li class="nav-item {{ $activeItem == 'item-management' ? ' active ' : '' }}">
                                            <a class="nav-link text-white {{ $activeItem == 'item-management' ? ' active ' : '' }}  "
                                                href="{{ route('items') }}">
                                                <span class="sidenav-mini-icon"> IM </span>
                                                <span class="sidenav-normal  ms-2  ps-1"> Items <b
                                                        class="caret"></b></span>
                                            </a>
                                        </li>
                                    @endcan
                                ...
                                <ul class="nav ">
                                    <li class="nav-item ">
                                        <a class="nav-link text-white {{ $activeItem == 'profile' ? ' active ' : '' }}  "
                                            ...
                                            <span class="sidenav-normal  ms-2  ps-1"> Profile <b
                                                    class="caret"></b></span>
                                        </a>
                                        <div class="collapse {{ $activeItem == 'profile' ? ' show ' : '' }} "
                                            id="profileExample">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link text-white {{ $activeSubitem == 'profile-overview' ? ' active ' : '' }}  "
                                                        href="{{ route('overview') }}">
                                                        <span class="sidenav-mini-icon"> P </span>
                                                        <span class="sidenav-normal  ms-2  ps-1"> Profile Overview
                                                        </span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white{{ $activeItem == 'users' ? ' active ' : '' }}  "
                                            ...
                                            <span class="sidenav-normal  ms-2  ps-1"> Users <b
                                                    class="caret"></b></span>
                                        </a>
                                        <div class="collapse {{ $activeItem == 'users' ? ' show ' : '' }} "
                                            id="usersExample">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white {{ $activeItem == 'account' ? ' active ' : '' }} "
                                            ...
                                            <span class="sidenav-mini-icon"> A </span>
                                            <span class="sidenav-normal  ms-2  ps-1"> Account <b
                                                    class="caret"></b></span>
                                        </a>
                                        <div class="collapse {{ $activeItem == 'account' ? ' show ' : '' }} "
                                            id="accountExample">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                    ...
                                    <li class="nav-item ">
                                        ...
                                        <div class="collapse {{ $activeItem == 'projects' ? ' show ' : '' }} "
                                            id="projectsExample">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse {{ $activePage == 'applications' ? 'show' : '' }} "
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse {{ $activePage == 'ecommerce' ? ' show ' : '' }} "
                                ...
                                <ul class="nav ">
                                    <li class="nav-item">
                                        <a class="nav-link text-white {{ $activeItem == 'products' ? ' active ' : '' }}"
                                            ...
                                            <span class="sidenav-mini-icon"> P </span>
                                            <span class="sidenav-normal  ms-2  ps-1"> Products <b
                                                    class="caret"></b></span>
                                        </a>
                                        <div class="collapse {{ $activeItem == 'products' ? ' show ' : '' }}"
                                            id="productsExample">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white {{ $activeItem == 'orders' ? ' active ' : '' }}"
                                            ...
                                            <span class="sidenav-normal  ms-2  ps-1"> Orders <b
                                                    class="caret"></b></span>
                                        </a>
                                        <div class="collapse {{ $activeItem == 'orders' ? ' show ' : '' }}"
                                            id="ordersExample">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                ...
                                <ul class="nav ">
                                    <li class="nav-item ">
                                        <a class="nav-link text-white " data-bs-toggle="collapse"
                                            ...
                                            <span class="sidenav-mini-icon"> S </span>
                                            <span class="sidenav-normal  ms-2  ps-1"> Sign In <b
                                                    class="caret"></b></span>
                                        </a>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white " data-bs-toggle="collapse"
                                            ...
                                            <span class="sidenav-mini-icon"> S </span>
                                            <span class="sidenav-normal  ms-2  ps-1"> Sign Up <b
                                                    class="caret"></b></span>
                                        </a>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white " data-bs-toggle="collapse"
                                            ...
                                            <span class="sidenav-mini-icon"> L </span>
                                            <span class="sidenav-normal  ms-2  ps-1"> Lock <b
                                                    class="caret"></b></span>
                                        </a>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white " data-bs-toggle="collapse"
                                            ...
                                            <span class="sidenav-mini-icon"> E </span>
                                            <span class="sidenav-normal  ms-2  ps-1"> Error <b
                                                    class="caret"></b></span>
                                        </a>
                                ...
                                <ul class="nav ">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white " data-bs-toggle="collapse"
                                            ...
                                            <span class="sidenav-normal  ms-2  ps-1"> Foundation <b
                                                    class="caret"></b></span>
                                        </a>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="componentsExamples">
                                <ul class="nav ">
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/alerts.html" target="_blank">
                                            <span class="sidenav-mini-icon"> A </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/badge.html" target="_blank">
                                            <span class="sidenav-mini-icon"> B </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/buttons.html" target="_blank">
                                            <span class="sidenav-mini-icon"> B </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/cards.html" target="_blank">
                                            <span class="sidenav-mini-icon"> C </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/carousel.html" target="_blank">
                                            <span class="sidenav-mini-icon"> C </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/collapse.html" target="_blank">
                                            <span class="sidenav-mini-icon"> C </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/dropdowns.html" target="_blank">
                                            <span class="sidenav-mini-icon"> D </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/forms.html" target="_blank">
                                            <span class="sidenav-mini-icon"> F </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/modal.html" target="_blank">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/navs.html" target="_blank">
                                            <span class="sidenav-mini-icon"> N </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/navbar.html" target="_blank">
                                            <span class="sidenav-mini-icon"> N </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/pagination.html" target="_blank">
                                            <span class="sidenav-mini-icon"> P </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/popovers.html" target="_blank">
                                            <span class="sidenav-mini-icon"> P </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/progress.html" target="_blank">
                                            <span class="sidenav-mini-icon"> P </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/spinners.html" target="_blank">
                                            <span class="sidenav-mini-icon"> S </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/tables.html" target="_blank">
                                            <span class="sidenav-mini-icon"> T </span>
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link text-white "
                                            href="../../documentation/components/tooltips.html" target="_blank">
                                            <span class="sidenav-mini-icon"> T </span>
